...
Card.Header = function CardHeader({ children, className = '', ...rest }) {
  return <div className={`card-header ${className}`.trim()} {...rest}>{children}</div>
}

Card.Title = function CardTitle({ children, className = '', ...rest }) {
  return <div className={`card-title ${className}`.trim()} {...rest}>{children}</div>
}

Card.Body = function CardBody({ children, className = '', ...rest }) {
  return <div className={`card-body ${className}`.trim()} {...rest}>{children}</div>
}

Card.Footer = function CardFooter({ children, className = '', ...rest }) {
  return <div className={`card-footer ${className}`.trim()} {...rest}>{children}</div>
}
